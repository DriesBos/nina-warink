      ...
      <div class="logo-Content">
        ...
        >
          <path
            id="love loveLeft"
            class="love loveLeft"
            d="M156.321 261.87L152.272 256.869C137.027 240.234 127.091 229.059 128.382 216.777C129.435 206.757 138.007 199.815 148.027 200.868C153.522 201.446 158.745 204.609 161.859 209.185C165.856 205.357 171.622 203.348 177.117 203.926C187.137 204.979 194.079 213.552 193.025 223.571C191.735 235.854 179.692 244.719 161.322 257.82L156.321 261.87Z"
            fill="currentColor"
          />
          <path
            id="path pathLeft"
            class="path pathLeft"
            d="M161 228.5C-100.765 587.325 679 578 977.736 275.596C1276.47 -26.809 127.482 93.1492 473.106 225.591C818.73 358.032 1131.64 396.995 977.736 548"
            stroke="black"
          />
        </svg>
      </div>
      ...
      <div class="logo-Content">
        ...
        >
          <path
            ...
            d="M804.321 261.87L800.272 256.869C785.027 240.234 775.091 229.059 776.382 216.777C777.435 206.757 786.007 199.815 796.027 200.868C801.522 201.446 806.745 204.609 809.859 209.185C813.856 205.357 819.622 203.348 825.117 203.926C835.137 204.979 842.079 213.552 841.025 223.571C839.735 235.854 827.692 244.719 809.322 257.82L804.321 261.87Z"
            fill="currentColor"
          />
          <path
            id="path pathRight"
            class="path pathRight"
            d="M808 230C808 230 399.357 39.6217 197.5 169C-44.2537 323.949 1087.5 263.5 900.5 384.5C713.499 505.5 224.5 689 49 484.5"
            stroke="black"
          />
        </svg>
      </div>
